...
class SpeciliatiesAdapter(val specialities: List<Speciality>, val listener: Listener) :
    RecyclerView.Adapter<SpeciliatiesAdapter.SpecialitiesViewHolder>() {
    interface Listener {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SpecialitiesViewHolder {
        val view =
            LayoutInflater.from(parent.context).inflate(R.layout.speciality_item, parent, false)
